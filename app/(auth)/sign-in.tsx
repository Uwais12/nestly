        ...
        <Glass style={styles.card}>
          ...
          {mode === 'otp' ? (
            <>
              ...
              <TouchableOpacity onPress={() => { setMode('password'); setShowOtpInput(false); }} style={styles.secondaryBtn}>
            ...
            <>
              ...
              <TouchableOpacity onPress={() => setMode('otp')} style={styles.secondaryBtn}>
