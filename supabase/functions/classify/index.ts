...
serve(async (req) => {
  try {
    ...
    if (keyLooksValid) {
      ...
      const body = { model: 'gpt-5-nano', messages: [ { role: 'system', content: system }, { role: 'user', content: text } ] };
    ...
    if (!results.length) {
      ...
      const map: Record<string, Tag> = {
        '#restaurant': 'Food', '#foodie': 'Food', 'menu': 'Food', 'recipe': 'Food', 'food hall': 'Food',
        'restaurant': 'Food', 'dining': 'Food', 'eatery': 'Food', 'brunch': 'Food', 'lunch': 'Food', 'dinner': 'Food',
        'breakfast': 'Food', 'cafe': 'Food', 'coffee': 'Food', 'bakery': 'Food', 'dessert': 'Food',

        'flight': 'Travel', '#wanderlust': 'Travel', 'itinerary': 'Travel', 'hotel': 'Travel', 'travel': 'Travel',
        'airport': 'Travel', 'station': 'Travel', 'tour': 'Travel', 'guide': 'Travel', 'museum': 'Travel',
        'london': 'Travel', 'paris': 'Travel', 'tokyo': 'Travel', 'rome': 'Travel', 'new york': 'Travel',
        'leicester square': 'Travel', 'central london': 'Travel',
